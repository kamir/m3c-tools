...
func printUsage(w *os.File) {
	...
	fmt.Fprintln(w, "")
	fmt.Fprintln(w, "The skill trust plane: pack, sign, admit, install, verify, audit, revoke.")
	fmt.Fprintln(w, "Run any command with --help for its own flags (the scanner family: with no arguments).")
	fmt.Fprintln(w, "")
	...
	fmt.Fprintln(w, "  doctor                  Check this machine's readiness: home dirs, trust roots, hook wiring.")
