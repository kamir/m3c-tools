...
|---|---|---|
| `skillctl-v0.4.0-registry.bundle` | tag `skillctl/v0.4.0` (commit `6b62ec5`) | a `local://` registry with `wire-freeze-canary@1.0.0`: the signed `.skb`, its `BundleAdmittedEvent` and its `AttestationPublishedEvent` |
