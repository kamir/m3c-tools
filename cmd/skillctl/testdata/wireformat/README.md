...
|---|---|---|
| `skillctl-v0.4.0-registry.bundle` | tag `skillctl/v0.4.0` (commit `1eeefc8`) | a `local://` registry with `wire-freeze-canary@1.0.0`: the signed `.skb`, its `BundleAdmittedEvent` and its `AttestationPublishedEvent` |
