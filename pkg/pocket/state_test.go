...
func TestFindGroupByFilePath(t *testing.T) {
		...
		Groups: []GroupMapping{
			{
				...
				Title:   "Test Session",
				FilePaths: []string{
					"/home/alice/m3c-data/pocket/raw/2026-04-02/20260402163416.mp3",
					"/home/alice/m3c-data/pocket/raw/2026-04-02/20260402171200.mp3",
				},
				Segments: 2,
			},
		},
	...
	result := FindGroupByFilePath("/home/alice/m3c-data/pocket/raw/2026-04-02/20260402163416.mp3", cfg)
	if result == nil {
