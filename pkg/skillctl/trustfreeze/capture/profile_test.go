...
func TestBuiltinProfiles(t *testing.T) {
	...
	if strings.Join(ub.Required, ",") != "common.identity,linux.packages,linux.users,linux.sudo,linux.ssh,linux.systemd,linux.network.listeners,linux.firewall,linux.mounts" {
