...
irm https://raw.githubusercontent.com/kamir/m3c-tools/6f517440e7edf64c74f0f625a46291769d086f98/scripts/skillctl-quickstart-windows.ps1 -OutFile $q
powershell -ExecutionPolicy Bypass -File $q
```

> **Bootstrap integrity.** These URLs are pinned to the **immutable commit `6f51744`**, not the
...
> `a00826f30599439718f5ea126f81b8a78b4c28aa96980e1b136db65396a34177`;
