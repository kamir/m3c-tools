...
irm https://raw.githubusercontent.com/kamir/m3c-tools/37cf8731d8d952cea33c705294f94b5313c86b3b/scripts/skillctl-quickstart-windows.ps1 -OutFile $q
powershell -ExecutionPolicy Bypass -File $q
```

> **Bootstrap integrity.** These URLs are pinned to the **immutable commit `37cf873`**, not the
