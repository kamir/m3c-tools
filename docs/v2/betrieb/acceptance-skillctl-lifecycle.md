...
> **Bootstrap integrity.** The installer URLs are pinned to the **immutable commit `37cf873`**
...
> **Pinned + verifiable.** Both URLs above are pinned to the **immutable commit `37cf873`**.
> Expected SHA-256: `tools/skillctl-install.ps1` → `a00826f30599439718f5ea126f81b8a78b4c28aa96980e1b136db65396a34177`;
