...
> **Bootstrap integrity.** The installer URLs are pinned to the **immutable commit `6f51744`**
...
> **Pinned + verifiable.** Both URLs above are pinned to the **immutable commit `6f51744`**.
