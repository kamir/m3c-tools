...
unveränderlichen Commit `37cf873` gepinnt und nicht auf `master`, denn ein
...
```bash
curl -fsSL https://raw.githubusercontent.com/kamir/m3c-tools/37cf8731d8d952cea33c705294f94b5313c86b3b/tools/skillctl-install.sh \
