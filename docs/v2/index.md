...
| [Runbook: thinking-engine](entwickler/thinking-engine.md) · [Runbook: skillctl-sim](entwickler/skillctl-sim.md) | die Per-User-Engine bauen und starten; die Trust-Plane-Simulation lesen | EN |
