...
([requirements](../../requirements-er1-integration.md),
...
2. **No YouTube API key.** `pkg/transcript` is a complete port of
   ...
   surface is preserved in [go-rewrite-plan](../../go-rewrite-plan.md)
   (historical).
...
(head of [Manual: skillctl](../../manual-skillctl.md), threat model in
...
| A new skillctl verb is REGISTERED in [CLI-VERBS](../../CLI-VERBS.md) before it is implemented; `verbaudit` turns CI red otherwise | CLI-VERBS.md, decided 2026-09-04 |
...
- Every command and flag: [Manual: m3c-tools](../../manual-m3c-tools.md),
  [Manual: skillctl](../../manual-skillctl.md)
- What works on which OS: [PLATFORM-DIFFERENCES](../../PLATFORM-DIFFERENCES.md)
- Historical design notes that still explain code:
  [go-rewrite-plan](../../go-rewrite-plan.md),
  [spec-plaud-er1-sync](../../spec-plaud-er1-sync.md),
  [requirements-er1-integration](../../requirements-er1-integration.md)
